...
void DS1_Clip_Tone(double *u, double *y, double *v1, double *v2, double *v3,  int N, double T, double *U_1, double *Y_1, double *V1_1, double *V2_1, double *V3_1, double t, double vol)
{
	...
	double const F1_1 = 1/( 2*R1*C1 );
	//double const F1_2 = 0;
	//double const F1_3 = 0;
	//double const F1_4 = 0;
	
	double const F2_1 = 1/( 2*R1*C2 );
	double const F2_2 = 1/( 2*R2*C2 );
	...
	double const A_1_2 = -1;
	double const A_1_3 = 0;
	double const A_1_4 = 0;
